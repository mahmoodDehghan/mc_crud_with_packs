Feature: Customer Management
  Scenario: Create a customer with correct entry
    GIVEN the customer form is loaded
    WHEN user fills and submit the form with| firstName:"mahmood" | lastName:"dehghan" | birthDate:July 16, 1990 | email:"mdm1369@gmail.com" | phoneNumber:"+989127606447" | bankAccountNumber:"IR110570033780012625008101" | 
    THEN 1 user with these details | firstName:"mahmood" | lastName:"dehghan" | birthDate:July 16, 1990 | email:"mdm1369@gmail.com" | phoneNumber:"+989127606447" | bankAccountNumber:"IR110570033780012625008101" | is created
  ...
  Scenario: Create a customer with same email is not allowed
    ...
    AND the customer form is loaded
  ...
  Scenario: Read a customer details
    GIVEN create 1 user with these details | firstName:"mahmood" | lastName:"dehghan" | birthDate:July 16, 1990 | email:"mdm1369@gmail.com" | phoneNumber:"+989127606447" | bankAccountNumber:"IR110570033780012625008101" |
    AND the customer list is loaded
  ...
  Scenario: Read all customers 
    GIVEN create 1 user with these details | firstName:"mahmood" | lastName:"dehghan" | birthDate:July 16, 1990 | email:"mdm1369@gmail.com" | phoneNumber:"+989127606447" | bankAccountNumber:"IR110570033780012625008101" |
    WHEN the customer list is loaded

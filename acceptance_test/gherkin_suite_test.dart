  ...
  executeTestSuite(
    configuration: FlutterTestConfiguration(
      stepDefinitions: [
        ...
        //mc steps
        thenGetAllCustomers(),
        givenBackgroundErrorStep(),
        thenMustbeCustomersMc(),
        whenEditUser(),
        whenDeleteUser(),
        whenCreate(),

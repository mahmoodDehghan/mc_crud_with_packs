...
///
/// ```dart
/// import 'localization/customer_localizations.dart';
///
/// return MaterialApp(
...
abstract class CustomerLocalizations {
  CustomerLocalizations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static CustomerLocalizations? of(BuildContext context) {
    return Localizations.of<CustomerLocalizations>(context, CustomerLocalizations);
  }
  ...
  /// The title of the module and example title
  ///
...
CustomerLocalizations lookupCustomerLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'en': return CustomerLocalizationsEn();
  }
